...
int main() {
    ...
    do {
        ...
        printf("=======================================\n");
        printf("[1] Ler Ficheiro de Estudantes\n");
        printf("[2] Exibir Estudantes em Memoria\n");
        printf("[3] Ordenar Lista de Estudantes\n");
        printf("[4] Pesquisar por Estudante\n");
        printf("[5] Gravar Dados Atualizados em Ficheiro\n");
        printf("[6] Inserir Estudante (Teclado)\n");
        printf("[7] Editar Estudante\n");
        printf("[8] Eliminar Estudante\n");
